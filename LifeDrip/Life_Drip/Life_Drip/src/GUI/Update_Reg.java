...
public class Update_Reg extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Update_Reg frame = new Update_Reg();
	...
	public Update_Reg() {
		...
		JLabel lblUpdateRegistrar = new JLabel("Update Registrar:");
		lblUpdateRegistrar.setFont(new Font("Arial", Font.BOLD | Font.ITALIC, 18));
		lblUpdateRegistrar.setBounds(10, 29, 212, 39);
		panel.add(lblUpdateRegistrar);
		...
		btnSearch.setBounds(351, 116, 117, 23);
		panel.add(btnSearch);
	}
