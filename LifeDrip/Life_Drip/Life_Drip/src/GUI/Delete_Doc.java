...
public class Delete_Doc extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Delete_Doc frame = new Delete_Doc();
	...
	public Delete_Doc() {
		...
		JLabel lblDeleteDoctor = new JLabel("Delete Doctor:");
		lblDeleteDoctor.setFont(new Font("Arial", Font.BOLD | Font.ITALIC, 18));
		lblDeleteDoctor.setBounds(10, 29, 212, 39);
		panel.add(lblDeleteDoctor);
		...
		button_2.setBounds(327, 116, 117, 23);
		panel.add(button_2);
	}
