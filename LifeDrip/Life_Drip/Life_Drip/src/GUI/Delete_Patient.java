...
public class Delete_Patient extends JFrame {
	...
	public Delete_Patient() {
		...
		lblDeletePatient.setFont(new Font("Arial", Font.BOLD | Font.ITALIC, 18));
		lblDeletePatient.setBounds(10, 29, 212, 39);
		panel.add(lblDeletePatient);
		...
		button_2.setBounds(358, 116, 117, 23);
		panel.add(button_2);
	}
